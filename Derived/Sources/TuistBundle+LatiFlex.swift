...
/// Since LatiFlex is a static framework, the bundle containing the resources is copied into the final product.
    static let module: Bundle = {
        let bundleName = "LatiFlex_LatiFlex"
        ...
        fatalError("unable to find bundle named LatiFlex_LatiFlex")
    }()
}
